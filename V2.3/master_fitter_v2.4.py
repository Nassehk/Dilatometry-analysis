#This version can opimize for effect of C on CTE of martensite. Selective optimization, X0 builder.
...
overal_fit_WF=4
err_end_slop_WF=7
err_maximum_transformation_WF=3
...
Bs_model=1 # can be 1 for imperical and 2 for t zero method (only works for Nasseh's x80)
Ms_model=2 # can be 1 for Andrews1, 2 for andrews 2, 3 for capdevilla, 4 for interaction model Jiajun Wang
...
#a0_alpha=     2.868610563539203604996776761143e-10
...
a0_gama =     3.637260170320229163146388551015e-10
a0_alpha=     2.867449590298752916950576766155e-10
CTE_alpha_a=  -1.092820881203190873210564451374e-11
CTE_alpha_b=  5.630826749228289583091745123568e-09
CTE_alpha_c=  1.417037228990739299461926181678e-05
c_wf_for_cte= 2.208130247843851983943763706009e-04
c_wf_for_a0=  2.605926932972764810542815565577e-12

a0_gama =     3.637213838196866556788441904731e-10
a0_alpha=     2.867845460633743823901099825034e-10
CTE_alpha_a=  -1.092686393561463809013206023831e-11
CTE_alpha_b=  6.055336705988613183742586915321e-09
CTE_alpha_c=  1.368654754975856095179902877090e-05
c_wf_for_cte= 2.162277382660086986337910630596e-04
c_wf_for_a0=  2.605926932972764810542815565577e-12



#a0_gama =     3.637164715781523028642321771864e-10
#a0_alpha=     2.867608560120383504947579420702e-10
#CTE_alpha_a=  -1.092820881203190873210564451374e-11
#CTE_alpha_b=  5.630826749228289583091745123568e-09
#CTE_alpha_c=  1.403422775351404440326470723921e-05
#c_wf_for_cte= 2.113489051736834134585102384918e-04
#c_wf_for_a0=  2.499512759762273846677802210639e-12
...
for i in range(len(file_list)):
    delta_L_tot=delta_L_tot+dil_master[i][int(file_list[i][1])-20]/file_list[i][5]
...
def corr_fact_l0(x):
    ...
    if L0_correction_method==2:
        err=(5+abs(dil_master[m][int(file_list[m][1])-20]/(file_list[m][5]+x)-delta_L_avr))**5-5**5
    return err
