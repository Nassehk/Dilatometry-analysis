...
#Load setup file which contains informaton that master_fitter and fitter needs to work.
#each line in the set file is like this:
#filename,Aus_min_row,Aus_max_row,fer_min_row,fer_max_row,L0,cementite conditions,
#values must be separeted by comma "," and all lines must end with a comma.
file_list=[]
